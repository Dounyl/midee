...
const fr: Messages = {
  ...
  'hud.transpose': 'Transposer en pause',
  'hud.transpose.reset': 'Réinitialiser en Do',
  ...
  'console.labels.visible': 'Afficher les degrés et noms de notes sur les notes et le clavier',
  'console.labels.hidden': 'Masquer les degrés et noms de notes',
  ...
  'hud.aria.zoom': 'Zoom',
  'hud.aria.transpose': 'Transposer la tonalité',
  'hud.aria.transposeReset': 'Réinitialiser la tonalité en Do',
  ...
  'learn.pa.backToList': 'Retour à la liste',
  'learn.pa.backToListAria': 'Retour à la vue liste du play-along',
  'learn.pa.backToListTip': 'Retour à la liste du play-along',
  ...
  'learn.pa.modeAria': 'Mode guidé',
  'learn.pa.modeLabel': 'Mode',
  'learn.pa.modeDemoAria': 'Mode démonstration',
  'learn.pa.modePracticeAria': 'Mode pratique',
  'learn.pa.modeDemoTip': 'Mode démonstration - garde tout l accompagnement guide audible',
  'learn.pa.modePracticeTip':
    'Mode pratique - seule la main opposée sonne, ou silence pour le travail des deux mains',
  'learn.pa.modeDemoLabel': 'Démo',
  'learn.pa.modePracticeLabel': 'Pratique',
  ...
  'learn.pa.summary.songTitle': 'Morceau terminé',
  'learn.pa.summary.songSubtitle': 'La lecture est finie. Voici le bilan de ce passage.',
  'learn.pa.summary.loopTitle': 'Boucle terminée',
  'learn.pa.summary.loopSubtitle': 'Le passage en boucle est terminé ({seconds}s).',
  'learn.pa.summary.hits': 'réussites',
  'learn.pa.summary.errors': 'mauvaises touches',
  'learn.pa.summary.perfect': 'timing parfait',
  'learn.pa.summary.good': 'timing correct',
  'learn.pa.summary.cancel': 'Annuler',
  'learn.pa.summary.continue': "Continuer l'exercice",
  'learn.pa.summary.done': 'Terminer',
  'learn.pa.prompt.startTitle': 'Choisir comment commencer ce passage',
  'learn.pa.prompt.startSubtitle': 'Sélectionnez un mode guidé avant de lancer le play-along.',
  'learn.pa.prompt.replayTitle': 'Choisir comment relancer la boucle',
  'learn.pa.prompt.replaySubtitle': 'Changez de mode ici avant que la boucle ne recommence.',
  'learn.pa.prompt.defaultCountdown':
    'Passage automatique à {mode} dans {seconds}s selon votre dernier choix.',
  'learn.pa.prompt.startNow': 'Démarrer maintenant',
