...
const ptBR: Messages = {
  ...
  'home.skipIntro': 'Não mostrar esta abertura novamente; entrar em Tocar por padrão.',
  ...
  'hud.transpose': 'Transpor em pausa',
  'hud.transpose.reset': 'Redefinir para C',
  ...
  'console.labels.visible': 'Mostrar solfejo e nomes das notas nas notas e no teclado',
  'console.labels.hidden': 'Ocultar solfejo e nomes das notas',
  ...
  'hud.aria.zoom': 'Zoom',
  'hud.aria.transpose': 'Transpor tonalidade',
  'hud.aria.transposeReset': 'Redefinir tonalidade para C',
  ...
  'learn.pa.backToList': 'Voltar para a lista',
  'learn.pa.backToListAria': 'Voltar para a visualização em lista do play-along',
  'learn.pa.backToListTip': 'Voltar para a lista do play-along',
  ...
  'learn.pa.summary.songTitle': 'Peça concluída',
  'learn.pa.summary.songSubtitle': 'A reprodução terminou. Aqui está o resumo desta passada.',
  'learn.pa.summary.loopTitle': 'Loop concluído',
  'learn.pa.summary.loopSubtitle': 'A volta do loop terminou ({seconds}s).',
  'learn.pa.summary.hits': 'acertos',
  'learn.pa.summary.errors': 'toques errados',
  'learn.pa.summary.perfect': 'tempo perfeito',
  'learn.pa.summary.good': 'tempo bom',
  ...
  'midiLibrary.homeLabel': 'Sua biblioteca MIDI',
  'midiLibrary.pickerLabel': 'Sua biblioteca MIDI',
  'midiLibrary.play': 'Tocar',
  'midiLibrary.practice': 'Praticar',
  'midiLibrary.empty': 'Seus MIDI enviados aparecerão aqui.',
  'midiLibrary.emptyHome':
    'Envie um MIDI uma vez e volte aqui quando quiser para tocar ou praticar.',
  'midiLibrary.emptyPicker':
    'Envie um MIDI uma vez e ele ficará aqui para replay ou prática rápida.',
  'midiLibrary.emptyLearn': 'Envie um MIDI para começar sua biblioteca de prática.',
  'midiLibrary.metaTracks': '{count} faixas',
