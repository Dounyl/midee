...
export const en = {
  ...
  'hud.transpose': 'Transpose while paused',
  'hud.transpose.reset': 'Reset to C',
  ...
  'console.labels.visible': 'Show solfege and note names on notes and keyboard',
  'console.labels.hidden': 'Hide solfege and note names',
  ...
  'hud.aria.zoom': 'Zoom',
  'hud.aria.transpose': 'Transpose key',
  'hud.aria.transposeReset': 'Reset key to C',
  ...
  'learn.pa.backToList': 'Back to list',
  'learn.pa.backToListAria': 'Return to the play-along list view',
  'learn.pa.backToListTip': 'Return to the play-along list',
  ...
  'learn.pa.summary.songTitle': 'Piece complete',
  'learn.pa.summary.songSubtitle': 'Playback finished. Here is how that pass felt.',
  'learn.pa.summary.loopTitle': 'Loop complete',
  'learn.pa.summary.loopSubtitle': 'Loop pass finished ({seconds}s).',
  'learn.pa.summary.hits': 'hits',
  'learn.pa.summary.errors': 'wrong presses',
  'learn.pa.summary.perfect': 'perfect timing',
  'learn.pa.summary.good': 'good timing',
